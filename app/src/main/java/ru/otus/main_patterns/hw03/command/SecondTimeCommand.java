...
/**
 Повторяет команду FirstTimeCommand.
 FirstTimeCommand - команда, которая повторяет команду failCommand.
 Т.е. SecondTimeCommand повторяет команду failCommand во второй раз.
*/
