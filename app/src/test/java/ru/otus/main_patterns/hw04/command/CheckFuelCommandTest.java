...
class CheckFuelCommandTest {
    ...
    @Test
    @DisplayName("Для объекта, имеющего 10 единиц топлива хватает топлива если израсходовать 2 единиц топлива")
    ...
    @Test
    @DisplayName("Для объекта, имеющего 8 единиц топлива не хватает топлива если израсходовать 10 единиц топлива")
    void shouldThrowNotEnoughFuelException() {
        ...
        // Act and Assert
        assertThatThrownBy(checkFuelCommandSpy::execute)
                .isInstanceOf(NotEnoughFuelException.class);
    }
